...
// Accepted document/image/video types for materials and submissions.
// Keep this in sync with ALLOWED_UPLOAD_TYPES in src/App.jsx (client-side check).
const ALLOWED = [
  "application/pdf",
...
// Videos are the largest files we accept; cap uploads at 200MB.
    ...
    const result = await handleUpload({
      ...
      onBeforeGenerateToken: async (_pathname, clientPayload) => {
        ...
        return {
          ...
          maximumSizeInBytes: MAX_UPLOAD_BYTES, // 200 MB (covers video uploads)
